...
public class LaboratoristasD implements LaboratoristasDAO {
    ...
    private final String INSERT = "INSERT INTO Laboratoristas (inicio,ocupado,estado,Persona_dpi,) VALUES (?,?,?,?)";
    ...
    public void modify(Laboratorista object) {
        ...
        try {
            ...
            stat.setString(3, object.getEstado());
            stat.setString(4, object.getPersona_dpi());
            stat.setInt(5, object.getRegistro());
            if (stat.executeUpdate() == 0) {
                System.out.println("crear popover Laboratoristas");
    ...
    @Override
    public Laboratorista obtener(Integer id) {
        PreparedStatement stat = null;
        ResultSet rs = null;
    ...
    public void delete(Laboratorista object) {
        ...
        try {
            ...
            stat.setInt(1, object.getRegistro());
            if (stat.executeUpdate() == 0) {
    ...
    public Laboratorista convertir(ResultSet rs) {
        ...
        try {
            Laboratorista laboratoristas = new Laboratorista(rs.getInt("registro"), rs.getDate("inicio"), rs.getString("ocupado"), rs.getString("estado"), rs.getString("Persona_dpi"));
